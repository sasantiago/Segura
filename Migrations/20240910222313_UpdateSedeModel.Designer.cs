...
namespace SEGURA_ASSETMENTS.Migrations
{
    ...
    [Migration("20240910222313_UpdateSedeModel")]
    partial class UpdateSedeModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SEGURA_ASSETMENTS.Models.Cliente", b =>
                {
                    ...
                    b.Property<string>("AuthCelular")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AuthCorreo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SEGURA_ASSETMENTS.Models.Reserva", b =>
                {
                    ...
                    b.Property<int>("ClienteID_Clientes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SEGURA_ASSETMENTS.Models.Reserva", b =>
                {
                    b.HasOne("SEGURA_ASSETMENTS.Models.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteID_Clientes")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
